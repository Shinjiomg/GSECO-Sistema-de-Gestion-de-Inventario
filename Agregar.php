  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="#" target="_blank">
        ...
        <span class="ms-1 font-weight-bold">Gestión Productos</span>
      </a>
    </div>
    ...
    <div class="sidenav-footer mx-3 ">
      <div class="card card-plain shadow-none" id="sidenavCard">
        ...
        <div class="card-body text-center p-3 w-100 pt-0">
          <div class="docs-info">
            <h6 class="mb-0">Dashboard productos</h6>
            <p class="text-xs font-weight-bold mb-0">Gestion</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder text-white mb-0">Editar</h6>
        </nav>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Id asignado para registrar el producto</label>
                                    <input class="form-control" name="txtIdProducto" type="number" disabled value="<?php echo $varConsultaMax; ?>">
                                    <input class="form-control" name="txtId" type="number" hidden value="<?php echo $idUsuario; ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Nombre del Producto</label>
                                    <input class="form-control" name="txtNombreProducto" autocomplete="off" type="text" value="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Cantidad</label>
                                    <input class="form-control" name="txtCantidad" autocomplete="off" type="number" value="">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <button type="submit" name="btnAgregar" class="btn btn-primary btn-sm ms-auto">Agregar</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="card shadow-lg">
      <div class="card-header pb-0 pt-3 ">
        <div class="float-start">
          ...
          <p>Opciones de configuracion para la interfaz</p>
        </div>
      ...
      <div class="card-body pt-sm-3 pt-0 overflow-auto">
        ...
        <a class="btn btn-danger w-100" href="../Php/Cerrar.php">Cerrar Sesion</a>
      </div>
    </div>
  </div>
  <!--   Core JS Files   -->
