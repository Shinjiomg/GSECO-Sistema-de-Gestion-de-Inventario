          ...
          <div class="card">
            <div class="card-header pb-1">
              <div class="d-flex justify-content-end mb-2">
                <div>
                  <button type="button" onclick="printProductsPDF('data_table_balance')" class="btn mb-0 text-uppercase"
                    style="background: #5e72e4; color:white"><i class="fas fa-file-pdf"></i> EXPORTAR A PDF</button>
                </div>
              </div>
            </div>
