<?php
    ...
    $querybuscar = mysqli_query($conn, "SELECT * FROM productos WHERE id_Producto=$codigo");
    while($mostrar = mysqli_fetch_array($querybuscar))
    {
        $Id = $mostrar['id_Producto'];
        $Producto = $mostrar['Nombre'];
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Id Producto</label>
                                    <input class="form-control" name="txtIdProducto" type="number" disabled value="<?php echo $Id; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="txtNombreProducto" autocomplete="off" type="text" value="<?php echo $Producto; ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Cantidad</label>
                                    <input class="form-control" name="txtCantidad" autocomplete="off" type="number" value="<?php echo $Cantidad; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <button type="submit" name="btnmodificar" class="btn btn-primary btn-sm ms-auto">Modificar</button>
                                </div>
                            </div>
                        </div>
                    </div>
