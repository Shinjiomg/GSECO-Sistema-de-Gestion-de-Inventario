                                ...
                                <ul class="list-group">
                                    <li
                                        ...
                                        <div class="d-flex align-items-center">
                                            <a onclick="viewPDFCompra(<?php echo $f->id_ingreso ?>)" target="_blank"
                                        ...
                                        <div class="column">
                                            ...
                                            <?php if ($f->estado === 1) { ?>
                                                <button
                                                    ...
                                                    class="btn mb-0  btn-md d-flex align-items-center justify-content-center text-uppercase"
                                                    onclick="changeStatus(<?php echo $f->id_ingreso ?>)">
                                                    <i class="fas fa-money-bill"></i>&nbsp;&nbsp;
                                                    Cambiar estado
                                                </button>
                                            <?php } else { ?>
                                                <button
                                                    style="background: green; box-shadow: 4px 4px 8px #303030; color:white; height: 50px !important"
                                                    class="btn mb-0  btn-md d-flex align-items-center justify-content-center text-uppercase">
