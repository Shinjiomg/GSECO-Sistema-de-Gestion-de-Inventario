                            ...
                            <div class="row pb-2 p-3">
                                ...
                                <div class="col-xl-8 text-end">
                                    <div class="d-flex justify-content-end mb-2">
                                        <div>
                                            <button type="button" onclick="printProductsPDF('data_table_products_export')" class="btn mb-0 text-uppercase" style="background: #5e72e4; color:white"><i class="fas fa-file-pdf"></i> EXPORTAR A PDF</button>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title text-uppercase font-weight-bold">Crear producto</h4>
                            ...
                            <div class="row pb-2 p-3">
                                ...
                                <div class="col-md-8 text-end">
                                    <div class="d-flex justify-content-end">
                                        <div>
                                            <button onclick="printProductsPDF('categories_table_export')" class="btn mb-0 text-uppercase" style="background: #5e72e4; color:white"><i class="fas fa-file-pdf"></i> EXPORTAR A PDF</button>
                                    ...
                                    <div class="modal fade" id="modal-form-categories" tabindex="1" role="dialog" aria-labelledby="modal-form" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title text-uppercase font-weight-bold">Crear categoría</h4>
                                                    <button type="button" class="btn bg-gradient-danger" data-bs-dismiss="modal">X</button>
